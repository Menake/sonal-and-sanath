...
//                 <div>
//                   <h3 className="text-center text-xl italic">Transport</h3>
//                   <div className="mt-5 text-justify text-sm">
//                     <div>
//                       We are excited to have you join us on our special day at{" "}
//                       {event.venue.name}. There will be a bus providing
//                       transport to and from the venue departing from Pakuranga
//                       and Newmarket.
//                     </div>
//                     <div className="my-4">
//                       If you would like to use the bus on the day please
//                       indicate below your preferred pick up location.
//                     </div>
//                     <div>
//                       As seating on the bus is limited, we encourage you to RSVP
//                       as soon as possible to secure your spot.
//                     </div>
//                   </div>

//                   <ul className="mt-8">
//                     <li> Pakuranga (Pick up: 15:00)</li>
//                     <li>Newmarket (Pick up: 15:30)</li>
//                     <li>Leaving {event.venue.name}: 12:00am</li>
//                   </ul>
